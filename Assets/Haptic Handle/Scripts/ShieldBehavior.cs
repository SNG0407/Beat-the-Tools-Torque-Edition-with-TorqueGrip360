...
public class ShieldBehavior : MonoBehaviour
{
    ...
    void CalculateTorqueFeedback(float distance, float angle, int BulletColor)
    {
        ...
        if (angle >= 0 && angle < 90) // 1
        {
            ...
            weight_A = 0;
            weight_B = Mathf.Sin(DesiredAngleRad) + (Mathf.Cos(DesiredAngleRad) / (2 * Mathf.Cos(30 * Mathf.Deg2Rad)));
            weight_C = Mathf.Cos(DesiredAngleRad) / Mathf.Cos(30 * Mathf.Deg2Rad);
        }
        else if (angle >= 90 && angle < 180) // 2
        {
            float DesiredAngleRad = (180 - angle) * Mathf.Deg2Rad;
            weight_A = Mathf.Cos(DesiredAngleRad) / Mathf.Cos(30 * Mathf.Deg2Rad);
            weight_B = Mathf.Sin(DesiredAngleRad) + (1 / (2 * Mathf.Cos(30 * Mathf.Deg2Rad)));
            weight_C = 0;
        }
        else if (angle >= 180 && angle < 210) // 3
        {
            float DesiredAngleRad = (210 - angle) * Mathf.Deg2Rad;
            weight_A = Mathf.Cos(DesiredAngleRad) + (Mathf.Sin(DesiredAngleRad) / (2 * Mathf.Cos(30 * Mathf.Deg2Rad)));
            weight_B = Mathf.Sin(DesiredAngleRad) / Mathf.Cos(30 * Mathf.Deg2Rad);
            weight_C = 0;
        }
        else if (angle >= 210 && angle < 270) // 4
        {
            float DesiredAngleRad = (300 - angle) * Mathf.Deg2Rad;
            weight_A = (Mathf.Cos(DesiredAngleRad) / (2 * Mathf.Cos(30 * Mathf.Deg2Rad))) + Mathf.Sin(DesiredAngleRad);
            weight_B = 0;
            weight_C = Mathf.Cos(DesiredAngleRad) / Mathf.Cos(30 * Mathf.Deg2Rad);
        }
        else if (angle >= 270 && angle < 330) // 5
        {
            float DesiredAngleRad = (330 - angle) * Mathf.Deg2Rad;
            weight_A = Mathf.Sin(DesiredAngleRad) / Mathf.Cos(30 * Mathf.Deg2Rad);
            weight_B = 0;
            weight_C = Mathf.Cos(DesiredAngleRad) + (Mathf.Sin(DesiredAngleRad) / (2 * Mathf.Cos(30 * Mathf.Deg2Rad)));
        }
        else if (angle >= 330 && angle < 360) // 6
        {
            float DesiredAngleRad = (420 - angle) * Mathf.Deg2Rad;
            weight_A = 0;
            weight_B = Mathf.Cos(DesiredAngleRad) / Mathf.Cos(30 * Mathf.Deg2Rad);
            weight_C = Mathf.Sin(DesiredAngleRad) + (Mathf.Cos(DesiredAngleRad) / (2 * Mathf.Cos(30 * Mathf.Deg2Rad)));
        }
